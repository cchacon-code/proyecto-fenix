...
export function PeoplePanel() {
  ...
  const filteredPeople = useMemo(
    () => peopleService.search(query, typeFilter),
    [people, query, typeFilter],
  );

  function refresh(): void {
    setPeople(peopleService.getAll());
  }
  ...
  function handleRemove(personId: string): void {
  ...
  return (
    <section className="people-panel">
      <div className="section-heading">
        <div>
          <span className="eyebrow">EduPeople</span>
      ...
      <div className="people-toolbar">
        ...
        <select
          value={typeFilter}
          onChange={(event) =>
            setTypeFilter(event.target.value as PersonType | 'all')
          }
        >
